...
interesting failures live BETWEEN them. "awgit is installed" is not the useful
fact -- "awgit is installed and the thing it pairs with is not" is. This reports
...
SELF = 'awgit'
FAMILY = ['awbac', 'awbrowse', 'awdit', 'awfind', 'awgraph', 'awiam', 'awkno', 'awm', 'awmail', 'awnboard', 'awnest', 'awnet', 'awnode', 'awprism', 'awreason', 'awrecover', 'awrecurse', 'awrelay', 'awrepl', 'awresearch', 'awrun', 'awseal', 'awshare', 'awtunnel']
...
def _local_checks() -> "list[str]":
    ...
    from the registry, but it does not know what awgit needs at runtime, and a
